...
public class StrategyDesign {
	public static void main(String[] args) {
		...
		System.out.println("Hey ✈️ can you fly?  " + airplane.tryToFly());
		System.out.println("Hey 🚲 can you fly? " + bike.tryToFly());

		//After a technical problem occurred on the plane,unfortunately it cannot fly
